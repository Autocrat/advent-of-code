...
fn main() {
    ...
    let max_shortest_connections : usize = 1000;
    ...
    let short_vec : Vec<_> = sorted_vector[0..max_shortest_connections].to_vec();


    let mut circuits_map : HashMap<(i64,i64,i64),usize> = HashMap::new();
    let mut next_circuit_num : usize = 0;
    let mut circuit_counts : Vec<usize> = vec![0;short_vec.len()];
    ...
    println!("{}*{}*{} = {}",circuit_counts[0],circuit_counts[1], circuit_counts[2], circuit_counts[0]*circuit_counts[1]* circuit_counts[2]);
